...
const HeaderSection = () => {
    ...
    return (
        <div className='' >
            ...
            <input onChange={(e)=>setQuery(e.target.value)} type="text" placeholder="Search your jobs" className=' w-full h-full py-2 px-3 rounded-full border border-gray-300 text-gray-700 focus:outline-none focus:ring-1 focus:ring-red-400'/>
